            ...
            <div id="vertical-form" class="p-5">
                ...
                <div class="preview">
                    ...
                    <div class="@error('job_description') input-form has-error @enderror mt-3">
                        ...
                        <textarea rows="4" id="frm-job-description" class="form-control" name="job_description">{{ old('job_description', isset($job) ? $job->job_description : '') }}</textarea>
                    ...
                    <div class="@error('responsibilities') input-form has-error @enderror mt-3">
                        ...
                        <textarea rows="4" id="frm-responsibilities" class="form-control" name="responsibilities">{{ old('responsibilities', isset($job) ? $job->responsibilities : '') }}</textarea>
                    ...
                    <div class="@error('benefit') input-form has-error @enderror mt-3">
                        ...
                        <textarea rows="4" id="frm-benefit" class="form-control" name="benefit">{{ old('benefit', isset($job) ? $job->benefit : '') }}</textarea>
                        @error('benefit')
                            <div class="pristine-error text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="@error('qualification') input-form has-error @enderror mt-3">
                        ...
                        <textarea rows="4" id="frm-qualification" class="form-control" name="qualification">{{ old('qualification', isset($job) ? $job->qualification : '') }}</textarea>
                        @error('qualification')
                            <div class="pristine-error text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>

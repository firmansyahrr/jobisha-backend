            ...
            <form method="POST" action="{{ route('candidate.store') }}" class="max-w-4xl m-auto"
                ...
                <div class="preview">
                    ...
                    <div class="@error('email') input-form has-error @enderror mt-3">
                        ...
                        <input id="frm-email" name="email" type="email" class="form-control"
                    ...
                    <div class="mt-3">
                        ...
                        <select class="tom-select w-full" name="province_id">
                            ...
                            <option value="{{ $data->id }}" @selected( old('province_id')==$data->id)>{{ $data->name }}
                            </option>
                            @endforeach
                        </select>
                        @error('province_id')
                    ...
                    <div class="mt-3">
                        ...
                        <select class="tom-select w-full" name="city_id">
                            ...
                            <option value="{{ $data->id }}" @selected( old('city_id')==$data->id)>{{ $data->name }}
                            </option>
                            @endforeach
                        </select>
                        @error('city_id')
                    ...
                    <div class="mt-3">
                        ...
                        <select class="tom-select w-full" name="gender_id">
                            ...
                            <option value="{{ $data->id }}" @selected( old('gender_id')==$data->id)>{{ $data->label }}
                            </option>
                            @endforeach
                        </select>
                        @error('gender_id')
                    ...
                    <div class="mt-3">
                        <label for="frm-password" class="form-label">Password</label>
                        <input id="frm-password" type="password" class="form-control" placeholder="secret"
                            name="password">
                        @error('password')
                        <div class="pristine-error text-danger mt-2">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mt-3">
                        <label for="frm-password-confirmation" class="form-label">Password Confirmation</label>
                        <input id="frm-password-confirmation" type="password" class="form-control" placeholder="secret"
